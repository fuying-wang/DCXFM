...
__all__ = ["CXRSegDatasetMapper"]


class CXRSegDatasetMapper:
    """
    ...
    def from_config(cls, cfg, is_train: bool = True):
        ...
        ret = {
            ...
            # By default, our dataset consists of images and their instance masks.
    ...
    def __call__(self, dataset_dict):
        ...
        # change image size after augmentation
    ...
    def _transform_annotations(self, dataset_dict, transforms, image_shape):
        ...
        # instances.set("captions", [annos[i]["caption"] for i in range(len(annos))])
