...
def add_cat_seg_config(cfg):
    ...
    # zero shot config
    cfg.MODEL.SEM_SEG_HEAD.MEDCLIP_CKPT = ""
    ...
    cfg.MODEL.CLIP_PIXEL_MEAN = [120.105, 120.105, 120.105]
    cfg.MODEL.CLIP_PIXEL_STD = [77.01, 77.01, 77.01]
    # three styles for clip classification, crop, mask, cropmask

    cfg.MODEL.SEM_SEG_HEAD.DATASET_DIR = ""
