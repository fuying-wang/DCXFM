...
from cxrseg import add_cat_seg_config
from detectron2.utils.logger import setup_logger
from cxrseg.utils.events import setup_wandb
...
$ ./analyze_model.py --tasks parameter \\
    ...
    python analyze_model.py --tasks parameter --config-file ../configs/vitb_r101_384.yaml
